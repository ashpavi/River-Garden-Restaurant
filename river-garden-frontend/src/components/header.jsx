    ...
    <header className="w-full absolute top-0 left-0 z-50">
      <div className=" bg-transparent shadow-md">
        <Container className="flex items-center justify-between py-4">
          ...
          ">
            <a href="#home" className="hover:text-[#ff7a42] font-medium">Home</a>
            <a href="#about" className="hover:text-[#ff7a42]">About Us</a>
            <a href="#menu" className="hover:text-[#ff7a42]">Menu</a>
            <a href="#offers" className="hover:text-[#ff7a42]">Offers</a>
